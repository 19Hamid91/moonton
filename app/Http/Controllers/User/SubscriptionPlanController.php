...
class SubscriptionPlanController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('User/Dashboard/SubscriptionPlan/Index', ['subscriptionPlans' => $subscriptionPlans, 'userSubcription' => null]);
    }
    ...
    public function userSubscribe(Request $request, SubscriptionPlan $subscriptionPlan)
    {
        $data = [
            ...
            // 'expired_date' => Carbon::now()->addMonths($subscriptionPlan->period_in_months),
